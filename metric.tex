...
Подмножество $\ell$ метрического пространства называется \index{line}\emph{отрезком}, если является изометрией на вещественную прямую.
\end{thm}

Тройка точек, лежащих на одной прямой, называется \index{collinear points}\emph{коллинеарной}.
...
Пусть $[P Q)$ обозначает \index{half-line}\emph{полуинтервал},
...
Подмножество отрезка $(P Q)$ между $P$ и $Q$ мы называем \index{segment}\emph{bynt} between $P$ and $Q$ and denoted by~$[P Q]$.
